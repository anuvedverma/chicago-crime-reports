...
class Consumer(threading.Thread):
	...
	def run(self):
		consumer = KafkaConsumer(bootstrap_servers='hdp-m.c.mpcs53013-2016.internal:6667',
				auto_offset_reset='latest')
		consumer.subscribe(['anuvedverma-crime-event'])
...
def main():
	...
	while True:
		if not thread.isAlive():
			...
			print("Listening for new messages in topic: 'anuvedverma-crime-event'...")
			time.sleep(15)
